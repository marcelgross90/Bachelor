...
Dieses Beispiel verdeutlicht noch einmal bildlich, dass der Entwickler nur den Einstiegspunkt \enquote{Dispatcher} kennen muss. Die Anwendung liefert selbst alle benötigten Informationen, um die Daten für die Anwendung nachzuladen.
